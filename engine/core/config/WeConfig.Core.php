...
$config['base_url'] 	= 'Desenvolvimento/framework/base';
...
$config['app_themes'] = array('demo' => 'demo');
...
$config['theme_alias'] = array('demo2' => 'hotsite');
